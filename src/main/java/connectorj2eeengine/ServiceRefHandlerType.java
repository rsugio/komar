...
public class ServiceRefHandlerType {
    ...
    protected connectorj2eeengine.String handlerName;
    ...
    protected List<connectorj2eeengine.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<connectorj2eeengine.String> portName;
     ...
     * @return
     *     possible object is
     *     {@link connectorj2eeengine.String }
     *     
     */
    public connectorj2eeengine.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(connectorj2eeengine.String value) {
     ...
     * 
     */
    public List<connectorj2eeengine.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<connectorj2eeengine.String>();
        }
     ...
     * 
     */
    public List<connectorj2eeengine.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<connectorj2eeengine.String>();
        }
