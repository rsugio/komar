...
public class ServiceRefHandlerType {
    ...
    protected connector15.String handlerName;
    ...
    protected List<connector15.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<connector15.String> portName;
     ...
     * @return
     *     possible object is
     *     {@link connector15.String }
     *     
     */
    public connector15.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(connector15.String value) {
     ...
     * 
     */
    public List<connector15.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<connector15.String>();
        }
     ...
     * 
     */
    public List<connector15.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<connector15.String>();
        }
